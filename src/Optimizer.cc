...
namespace VDO_SLAM
{
    ...
    void Optimizer::PartialBatchOptimization(Map *pMap, const cv::Mat Calib_K, const int WINDOW_SIZE)
    {
        ...
        if (check_before_opt)
        {
            ...
            cout << "(" << vpEdgeSE3PointSta.size() << ") "
                 << "EdgeSE3PointSta chi2: " << endl;
            ...
            if (STATIC_ONLY == false)
            {
                ...
                cout << "(" << vpEdgeLandmarkMotion.size() << ") "
                     << "LandmarkMotionTernaryEdge chi2: " << endl;
                ...
                cout << "(" << vpEdgeSE3PointDyn.size() << ") "
                     << "EdgeSE3PointDyn chi2: " << endl;
                ...
                if (ALTITUDE_CONSTRAINT)
                {
                    cout << "(" << vpEdgeSE3Altitude.size() << ") "
                         << "vpEdgeSE3Altitude chi2: " << endl;
                ...
                {
                    cout << "(" << vpEdgeSE3Smooth.size() << ") "
                         << "vpEdgeSE3Smooth chi2: " << endl;
